    ...
    failGame: function () {
        ...
        this.oBird.style.display = 'none';
         if (this.score > 4) {  
            ...
            successText.innerHTML = '你成功了！<br>继续你的征程吧！';
          //  endDiv.textContent = '你成功了';    
            successText.style.color='red';  
            successText.style.fontFamily='pixel';
            successText.style.fontSize='15px';
            this.oEnd.querySelector('.over').parentNode.replaceChild(successText, this.oEnd.querySelector('.over'));  
        }  
